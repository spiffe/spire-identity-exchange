...
type MintCertificateRequest struct {
	...
	// When len(pluginAuthList ) > 1, which stack are you authenticating against.
	StackName     string `protobuf:"bytes,7,opt,name=stackName,proto3" json:"stackName,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MintCertificateRequest) GetStackName() string {
	if x != nil {
		return x.StackName
	}
	return ""
...
type MintCertificateRequest_PluginAuthList struct {
	...
	// registry. Same plugin pool as the REST /svid/{stack}/x509 endpoint.
...
const file_SpireIdentityExchangeApi_proto_rawDesc = "" +
	...
	"\x03ttl\x18\x01 \x01(\x05R\x03ttl\"\xeb\x04\n" +
	...
	"\x13serverKeyGenRequest\x18\x05 \x01(\v27.proto.spiffe.spireidentityexchange.ServerKeyGenRequestR\x13serverKeyGenRequest\x12\x1c\n" +
	"\tstackName\x18\a \x01(\tR\tstackNameB\f\n" +
	"\n" +
	"AuthMethod\"\xaa\x01\n" +
